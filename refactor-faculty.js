...
function refactorFile(filePath) {
    ...
    // Border Radius (keep rounded-full, rounded-md, rounded-sm, rounded)
    ...
    content = content.replace(/hover:bg-indigo-[45]00/g, 'hover:bg-primary/90');
...
const files = [
    ...
    "app/(faculty)/faculty/drives/[driveId]/rankings/page.tsx",
