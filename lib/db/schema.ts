...
// Dimension 384 matches the output of `all-MiniLM-L6-v2` (Xenova/transformers).
// The vector is stored as a PostgreSQL `vector(384)` column.
...
export const students = pgTable("students", {
  ...
  /**
   * 384-dimensional embedding vector of the student profile.
   * Generated by all-MiniLM-L6-v2 via @xenova/transformers.
...
export const drives = pgTable("drives", {
  ...
  /**
   * 384-dimensional embedding of the JD.
   * Generated by the generate_embedding job using all-MiniLM-L6-v2.
