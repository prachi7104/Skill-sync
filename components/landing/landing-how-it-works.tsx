...
export default function LandingHowItWorks() {
  ...
  return (
    <section id='how-it-works' className='w-full border-b border-border bg-background px-4 py-16 sm:px-6 lg:px-8'>
      <div className='mx-auto max-w-[1200px]'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
          {steps.map((step, index) => {
            const card = (
              <article className='h-full rounded-lg border border-border bg-card p-5 shadow-sm transition-transform duration-200 hover:-translate-y-0.5'>
