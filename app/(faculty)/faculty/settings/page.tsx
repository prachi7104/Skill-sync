  ...
  return (
    <div className="max-w-2xl mx-auto p-8 space-y-6">
      ...
      <section className="bg-card rounded-md border border-border p-6 space-y-3">
        ...
        <p className="text-sm text-foreground capitalize">Role: {session?.user?.role || "-"}</p>
      </section>
      ...
      <form onSubmit={handleChangePassword} className="bg-card rounded-md border border-border p-6 space-y-4">
        ...
        <input
          ...
          required
          className="w-full bg-secondary border border-border text-foreground rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-primary"
        />
        <input
          type="password"
        ...
        <button
          ...
          className="w-full bg-primary hover:bg-primary disabled:bg-muted text-foreground font-bold py-3 rounded-xl text-sm transition-all"
        >
