...
//                 </h1>
//                 <p className="text-slate-400 text-lg font-medium">
//                     Welcome back, <span className="text-slate-100 font-bold">{user.name}</span>.
//                 </p>
//             </div>

//             {/* Top Stats Grid */}
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
//                 <StatCard title="Placement Drives" value={stats.activeDrivesCount} icon={Briefcase} subtitle="Active now" />
//                 <StatCard title="Rankings" value={stats.rankingsCount} icon={Award} subtitle="Received" />
//                 <StatCard title="Profile Score" value={`${score}%`} icon={BarChart3} subtitle="Completeness" />
//                 <StatCard title="Sandbox Usage" value={`${sandboxUsageToday}/5`} icon={Eye} subtitle="Today" />
//             </div>

//             {/* Middle Grid: Resume & Completeness */}
//             <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
//                 <div className="lg:col-span-2 bg-slate-900/60 rounded-[2.5rem] border border-white/5 p-8 space-y-6 relative overflow-hidden group">
//                     <div className="flex items-center space-x-3 text-indigo-400 relative z-10">
//                         <FileText className="w-6 h-6" />
...
//                                     </a>
//                                     <Link href="/student/profile"
//                                           className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-sm font-bold shadow-[0_0_20px_rgba(79,70,229,0.3)]">
//                                         Update
//                                     </Link>
//                                 </div>
//                             </>
...
//                                 </div>
//                                 <Link href="/student/onboarding/resume"
//                                       className="px-6 py-3 bg-white text-black rounded-xl text-sm font-bold hover:bg-slate-200 transition-all shadow-lg">
//                                     Upload Now
//                                 </Link>
//                             </div>
//                         )}
...
//                         </div>
//                         <div className="h-2.5 w-full bg-slate-950 rounded-full overflow-hidden border border-white/5">
//                            <div className="h-full bg-emerald-500 rounded-full transition-all ease-out shadow-[0_0_15px_rgba(16,185,129,0.6)]" style={{ width: `${score}%` }} />
//                         </div>
//                     </div>
...
//             {/* RESTORED: Profile Sections Grid */}
//             <div className="bg-slate-900/60 rounded-[2.5rem] border border-white/5 p-8 md:p-10">
//                 <h3 className="font-bold text-white mb-8 text-xl tracking-tight">Data Parameters</h3>
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
//                    <ProfileSectionItem label="Core Skills" count={student.skills?.length || 0} min={5} />
...
// function ProfileSectionItem({ label, count, min, isOptional }: ProfileSectionItemProps) {
//   const isGood = count >= min;
//   return (
//     <div className="flex items-center justify-between p-6 rounded-2xl border border-white/5 bg-slate-950/50 hover:bg-slate-900 hover:border-white/10 transition-all duration-300">
//       <div>
...
//                 }
//             } catch {
//                 // Handled for production stability
//             }
//         }
//         if (student) fetchStats();
//     }, [student]);
...
//             <div className="max-w-6xl mx-auto space-y-10 p-8 md:p-10 pb-40 animate-in fade-in slide-in-from-bottom-4 duration-700">
...
//                 {/* 4. Data Parameters Section - Restored and Fixed for Scrolling */}
//                 <div className="bg-slate-900/60 rounded-[2.5rem] border border-white/5 p-8 md:p-10">
//                     <h3 className="font-bold text-white mb-8 text-xl tracking-tight">Data Parameters</h3>
//                     <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
//                        <ProfileSectionItem label="Core Skills" count={student.skills?.length || 0} min={5} />
...
//                     <div className="mt-10 flex justify-end">
//                        <Link href="/student/profile"
//                              className="group flex items-center bg-slate-950 border border-slate-800 text-slate-200 rounded-xl px-8 py-4 font-bold text-sm hover:text-white transition-all shadow-sm">
//                              Manage Full Profile 
//                              <ArrowRight className="ml-3 w-4 h-4 text-slate-500 group-hover:translate-x-1 group-hover:text-white transition-all" />
//                        </Link>
//                     </div>
...
// function ProfileSectionItem({ label, count, min, isOptional }: ParameterItemProps) {
//   const isGood = count >= min;
//   return (
//     <div className="flex items-center justify-between p-6 rounded-2xl border border-white/5 bg-slate-950/50 hover:bg-slate-900 hover:border-white/10 transition-all duration-300">
//       <div>
